...
public class AC_travel_1_Sathira_Pano_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_travel1_sathira_pano2);
...
//          Bitmap inputPANO = BitmapFactory.decodeResource(getResources(), R.drawable.sathira_panarama_1);
            ...
            mVRPanoramaView.loadImageFromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.sathira_panarama_2), options);
            inputStream.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
