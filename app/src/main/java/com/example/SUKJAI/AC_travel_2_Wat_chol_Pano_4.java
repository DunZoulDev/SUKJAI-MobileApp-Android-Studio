...
public class AC_travel_2_Wat_chol_Pano_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_travel2_wat_chol_pano4);
    ...
    private void loadPhotoSphere() {
        ...
        try {
            ...
            mVRPanoramaView.loadImageFromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.wat_chol_panarama_4), options);
            inputStream.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
