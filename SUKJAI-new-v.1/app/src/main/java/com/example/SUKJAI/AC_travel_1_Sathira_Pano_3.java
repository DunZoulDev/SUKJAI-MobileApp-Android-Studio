...
public class AC_travel_1_Sathira_Pano_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ac_travel1_sathira_pano3);
...
//          Bitmap inputPANO = BitmapFactory.decodeResource(getResources(), R.drawable.sathira_panarama_1);
            ...
            mVRPanoramaView.loadImageFromBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.sathira_panarama_3), options);
            inputStream.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
